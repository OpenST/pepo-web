...
export PEPO_INVITE_DOMAIN='http://invite.pepodev.com:8080';
export PEPO_FIREBASE_DOMAIN='http://app.pepodev.com:8080';
...
export PEPO_ANDROID_PACKAGE_NAME='com.pepo.staging';
