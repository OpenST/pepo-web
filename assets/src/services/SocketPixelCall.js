...
class SocketPixelCall {
  ...
  setPepoSocket(pepoSocket) {
    console.log(LOG_TAG, "setPepoSocket called");
  ...
  onConnect = () => {
    console.log(LOG_TAG, "onConnect");
    this.isConnected = true;
    this.fireBufferedEvent();
  };

  onDisconnect = () => {
    console.log(LOG_TAG, "onDisconnect");
    this.isConnected = false;
  };
  ...
  fireEvent(events) {
    ...
    console.log(LOG_TAG, "fireEvent called for events", events);
    ...
    console.log(LOG_TAG, "events", JSON.stringify(events) );
